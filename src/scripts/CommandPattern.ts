...
//   off: Command
//
//   constructor(on: Command, off: Command) {
//     this.off = off
//     this.on = on
//   }
//
...
//   const lightOn = new LightOnCommand(new Light())
//   const lightOff = new LightOffCommand(new Light())
//
//   const inv = new Invoker(lightOn, lightOff)
//
//   inv.clickOn()
//   inv.clickOff()
// }
